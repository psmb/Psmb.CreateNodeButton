...
export default class CreateNodeView extends Component {
    ...
    createNode = () => {
        ...
        const type =
            "Neos.Neos.Ui:Create" +
            this.props.options.position.charAt(0).toUpperCase() +
            this.props.options.position.slice(1);
        ...
        return this.props.options.enabled ? (
            <div style={{ display: "inline-block" }}>
                <div style={{ display: "flex" }}>
                    ...
                    />
                    <Button style="lighter" onClick={() => this.createNode()}>
                        {this.props.i18nRegistry.translate(
                            "Psmb.CreateNodeButton:Main:create"
                        )}
                    </Button>
                </div>
            </div>
